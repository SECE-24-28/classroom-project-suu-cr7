  ...
  return (
    <div className={`${isDark ? 'bg-gray-900' : 'bg-blue-100'} min-h-screen`}>
      ...
      <div className="container mx-auto px-4 py-12">
        <h2 className="text-2xl font-bold text-center text-primary mb-8">Quick Recharge</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div className="text-center">
            <h3 className="text-xl font-semibold text-primary mb-3">Prepaid Recharge</h3>
            <p className="text-gray-600 mb-4">Instant recharge with exciting offers</p>
            <Link to="/recharge" className="bg-primary text-white px-8 py-3 rounded-full hover:bg-opacity-90 transition font-medium">Recharge Now</Link>
          </div>
          <div className="text-center">
            <h3 className="text-xl font-semibold text-primary mb-3">Postpaid Bill Pay</h3>
            <p className="text-gray-600 mb-4">Pay bills instantly, avoid late fees</p>
            <Link to="/recharge" className="bg-secondary text-white px-8 py-3 rounded-full hover:bg-opacity-90 transition font-medium">Pay Bill</Link>
          </div>
        </div>
      </div>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
              <img src={irImg} alt="Instant Recharge" className="w-20 h-20 mx-auto mb-4 rounded" />
            ...
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
              <img src={documentsImg} alt="Best Offers" className="w-20 h-20 mx-auto mb-4 rounded" />
            ...
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
              <img src={seImg} alt="100% Secure" className="w-24 h-24 mx-auto mb-4 rounded" />
            ...
            <div className="text-center bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition">
              <img src={suImg} alt="24/7 Support" className="w-24 h-24 mx-auto mb-4 rounded" />
      ...
      <div className="container mx-auto px-4 py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            <img src={airImg} alt="Airtel" className="w-16 h-16 mx-auto mb-3 rounded" />
            <h3 className="font-semibold">Airtel</h3>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            <img src={jioImg} alt="Jio" className="w-16 h-16 mx-auto mb-3 rounded" />
            <h3 className="font-semibold">Jio</h3>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            <img src={voImg} alt="Vodafone" className="w-16 h-16 mx-auto mb-3 rounded" />
            <h3 className="font-semibold">Vi</h3>
          </div>
          <div className="bg-white p-6 rounded-lg shadow-md text-center hover:shadow-lg transition">
            <img src={bsnlImg} alt="BSNL" className="w-16 h-16 mx-auto mb-3 rounded" />
